        ...
        <section className="bg-center bg-fixed bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-48">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    ...
                    <Link href={"/#tech"} className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                        Quiero saber más
                        <IoArrowForward className="font-bold w-4 h-4 ms-2 rtl:rotate-180"/>
                    </Link>
                    <Link href="/pages/nosotros" className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                        Quienes somos?
                    </Link>
